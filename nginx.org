...
-ngx_http_wait_request_handler()
  -ngx_http_process_request_headers()
    -ngx_http_core_run_phases()
      ...
      -ngx_http_core_content_phase()       NGX_HTTP_CONTENT_PHASE阶段->checker
...
#+END_EXAMPLE
#+BEGIN_EXAMPLE
-ngx_http_upstream_process_header()           ~/src/http/ngx_http_upstream.c
#+END_EXAMPLE
...
* SSL
 - ngx_openssl_module
   ...
   : 对接底层openssl库
 - ngx_http_ssl_module
   : 定义在~/src/http/modules/ngx_http_ssl_module.c
